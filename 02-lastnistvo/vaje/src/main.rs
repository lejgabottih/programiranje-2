...
fn on_stack() {
    ...
    let mut a = [13; 100];          //100 array dolzine 100 s 13
    let mut b = a;                  //200 skopira a
    let q = String::from("13");     //201 
    println!("{}", q);              //    samo izpise 13
    let r = q;                      //    prevzame lastnistvo
    let p = &r;                     //    sposodi si ga
    a[0] = 1;                       //200 spremeni samo v a    
    {
        let c = &b;                 //    sposodi b
        println!("{}", c[0]);       //    izpise 13
    }
    println!("{}", b[0]);           //    izpise 13 
    println!("{}", a[0]);           //    izpise 1
    println!("{}", p);              //    izpise 13
    println!("{}", r);              //    izpise 13
    // println!("{}", q); // Razloži, zakaj to ne deluje, nima vec lastnistva
}
...
fn str_own2() {
    let x = (1, 2, (), String::from("Hello world"));    //lahko tudi zbrisemo String::from da bo vse na stacku
    let y = &x;
    println!("{:?}, {:?}", x, y);
}
...
/// Pojasnite, zakaj spodnja koda ne deluje: ker si dvakrat sposojamo mut s
fn fn8() {
    // let mut s = String::from("hello, ");
...
/// ------------------------------------------------------------------------------------------------
/// Pojasnite, zakaj spodnja koda ne deluje in jo popravite: isto
